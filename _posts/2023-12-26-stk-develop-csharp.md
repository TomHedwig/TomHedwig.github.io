...
![](/2023-12-26-stk-develop-csharp/register_dll.png)
...
![](/2023-12-26-stk-develop-csharp/build_stk9.png)

+ STK 11 应选择 **any CPU** 并保持 **Prefer 32-bit** 选项处于未勾选的状态

![](/2023-12-26-stk-develop-csharp/build_stk11.png)
...
![](/2023-12-26-stk-develop-csharp/reference_assembly.png)
...
![](/2023-12-26-stk-develop-csharp/reference_com_stk9.png)
...
![](/2023-12-26-stk-develop-csharp/reference_browse_stk9.png)
...
![](/2023-12-26-stk-develop-csharp/reference_browse_stk11.png)

### 引用属性设置

完成全部引用后，必须将上述引用的 **全部内容** 的 **Embed Interop Types** 属性设置为 **false**

![](/2023-12-26-stk-develop-csharp/properties.png)

## 抛出异常

![](/2023-12-26-stk-develop-csharp/exception_instance.png)
...
![](/2023-12-26-stk-develop-csharp/exception_thread.png)
