...
tags: [Phone]
excerpt: 记录一下获取 Xiaomi 13 的 root 权限的过程
---
...
在这台 Xiaomi 13 上，刷入 [Pandora](https://pd.qq.com/s/5ic94dcqt) 内核并使用 [Scene](http://vtools.omarea.com/#/) 控制调度：
...
|      `Scene的附加模块`      |                              无                              |   安装 [Scene](http://vtools.omarea.com/#/) 应用后附带安装   |
...
|      `Scene`      |                              无                              |   安装 [Scene](http://vtools.omarea.com/#/) 应用后附带安装   |
